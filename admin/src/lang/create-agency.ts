...
const strings = new LocalizedStrings({
  fr: {
    ...
    CREATE_AGENCY_SUCCESS: 'Agence créée. Un e-mail d’activation a été envoyé à l’adresse indiquée.',
  ...
  en: {
    ...
    CREATE_AGENCY_SUCCESS: 'Agency created. An activation email was sent to the address you entered—please verify to finish setup.',
