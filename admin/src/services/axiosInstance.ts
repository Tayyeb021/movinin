...
const ACCESS_TOKEN_KEY = 'mi-be-access-token'
...
if (typeof baseURL !== 'string' || !baseURL || baseURL === 'undefined') {
  console.error(
    '[Movinin Admin] VITE_MI_API_HOST is not set. Set it at build time (e.g. in Railway: Variables → VITE_MI_API_HOST = your backend URL).'
  )
}
